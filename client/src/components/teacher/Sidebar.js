...
export default function Sidebar() {
  ...
  const userName = token ? jwtDecode(token).userName : "Teacher";
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "24px 20px 20px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <span style={{ color: "rgba(255,255,255,0.35)", fontSize: "11px", letterSpacing: "1px", textTransform: "uppercase", marginLeft: "42px" }}>
          Teacher Portal
        </span>
      </div>
      ...
      <div style={{ padding: "20px", display: "flex", alignItems: "center", gap: "12px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div style={{ overflow: "hidden" }}>
          ...
          <div style={{ color: "rgba(255,255,255,0.4)", fontSize: "11px" }}>Teacher</div>
        </div>
      </div>

      {/* Nav */}
      <nav style={{ flex: 1, padding: "16px 12px", display: "flex", flexDirection: "column", gap: "4px" }}>
        <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "10px", letterSpacing: "1.2px", textTransform: "uppercase", padding: "0 8px", marginBottom: "8px" }}>
          Navigation
        </div>
          ...
          return (
            <div
              ...
              style={{
                ...
                background: isActive
                  ? "linear-gradient(135deg, rgba(14,165,233,0.35), rgba(2,132,199,0.2))"
                  : "transparent",
                border: isActive
